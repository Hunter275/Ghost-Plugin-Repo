...
<div class="form-group">
  <div class="input-group">
    ...
    <input required type="text" data-minlength="5" data-error="Please enter an item name (at least 5 characters)" class="form-control" name="name" value="<? echo $name; ?>" style="width:217px;">
  </div>
